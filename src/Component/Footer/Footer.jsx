        ...
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    ...
                    <p class="max-w-sm mt-2 text-gray-500 dark:text-gray-400">1M users use this app for control their work and increase there productivity.Also help ther activities to track.</p>
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">CsTicket@email.com</span>
                    </div>
                </div>
            </div>
        </div>
